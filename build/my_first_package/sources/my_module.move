module my_first_package::my_module {
    ...
    fun test_hash_result() {
        ...
        test_scenario::next_tx(scenario, admin);
        {
            ...
            let sig = vector<u8>[      23,  80, 135, 243, 140, 252, 181, 223, 183, 209, 106,
    192,  49,  98, 103, 224, 153,  28,  74, 169, 102, 144,
    233, 114,  16, 232, 217, 241, 247, 211,  64,  73, 142,
      2,  20,  62, 116, 162, 196,  98, 241, 214,  41,  93,
    144, 180, 162, 192, 120,  26, 192, 162,  33, 135, 182,
     90,  96,  78, 247, 252,  55, 145, 192,   6];
